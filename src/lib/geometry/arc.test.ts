...
describe('tessellateArc', () => {
  it('should throw error for less than 2 points', () => {
    ...
    expect(() => tessellateArc(arc, 1)).toThrow('Arc tessellation requires at least 2 points');
    expect(() => tessellateArc(arc, 0)).toThrow('Arc tessellation requires at least 2 points');
  });
