...
describe('getBoundingBoxForLine', () => {
  ...
  it('throws error for invalid line', () => {
    ...
    expect(() => getBoundingBoxForLine(invalidLine)).toThrow('Invalid line');
  });
});
...
describe('getBoundingBoxForCircle', () => {
  ...
  it('throws error for invalid circle', () => {
    ...
    expect(() => getBoundingBoxForCircle(invalidCircle)).toThrow('Invalid circle');
  });
});
...
describe('getBoundingBoxForPolyline', () => {
  ...
  it('throws error for empty polyline', () => {
    ...
    expect(() => getBoundingBoxForPolyline(emptyPolyline)).toThrow('Invalid polyline');
  });
...
describe('getBoundingBoxForEllipse', () => {
  ...
  it('throws error for invalid ellipse', () => {
    ...
    expect(() => getBoundingBoxForEllipse(invalidEllipse)).toThrow('Invalid ellipse');
  });
});
...
describe('getBoundingBoxForSpline', () => {
  ...
  it('throws error for spline without control points', () => {
    ...
    expect(() => getBoundingBoxForSpline(invalidSpline)).toThrow('Invalid spline');
  });
});
...
describe('combineBoundingBoxes', () => {
  ...
  it('throws error for empty array', () => {
    expect(() => combineBoundingBoxes([])).toThrow('Cannot combine empty array');
  });
  ...
  it('throws error for invalid bounding box', () => {
    ...
    expect(() => combineBoundingBoxes(invalidBoxes)).toThrow('Invalid bounding box');
  });
});
...
describe('getBoundingBoxForShapes', () => {
  ...
  it('throws error for empty shapes array', () => {
    expect(() => getBoundingBoxForShapes([])).toThrow('Cannot calculate bounding box for empty array');
  });
});
...
describe('Edge Cases - getBoundingBoxForCircle', () => {
  it('should throw error for circle with NaN center', () => {
    ...
    expect(() => getBoundingBoxForCircle(circle)).toThrow('Invalid circle: center must be finite and radius must be positive');
  });
...
describe('Edge Cases - getBoundingBoxForArc', () => {
  it('should throw error for arc with NaN center', () => {
    ...
    expect(() => getBoundingBoxForArc(arc)).toThrow('Invalid arc: center, radius, and angles must be finite numbers');
  });
...
describe('Edge Cases - getBoundingBoxForEllipse', () => {
  it('should throw error for ellipse with NaN center', () => {
    ...
    expect(() => getBoundingBoxForEllipse(ellipse)).toThrow('Invalid ellipse: center, major axis endpoint, and ratio must be finite numbers');
  });
  ...
  it('should throw error for ellipse with zero major axis length', () => {
    ...
    expect(() => getBoundingBoxForEllipse(ellipse)).toThrow('Invalid ellipse: major axis length must be positive');
  });
...
describe('Edge Cases - getBoundingBoxForSpline', () => {
  it('should throw error for spline with no control points', () => {
    ...
    expect(() => getBoundingBoxForSpline(spline)).toThrow('Invalid spline: must have control points');
  });
  ...
  it('should throw error when no finite points available', () => {
    ...
    expect(() => getBoundingBoxForSpline(spline)).toThrow('Invalid spline: no finite points found');
  });
    ...
    const shapes: Shape[] = [
      {
        id: 'line1',
        type: 'line',
        geometry: { start: { x: 0, y: 0 }, end: { x: 100000, y: 100000 } } // Huge diagonal
      }
    ];
