...
describe('fillArcToIntersection', () => {
  ...
  const pointOnCircle = (centerX: number, centerY: number, radius: number, angle: number) => ({
  ...
  describe('direction determination', () => {
    ...
    it('should auto-determine direction based on angular proximity', () => {
      ...
      const result1 = fillArcToIntersection(arc, nearStart, defaultOptions);
  ...
  describe('error handling', () => {
    it('should reject non-arc shapes', () => {
      ...
      const result = fillArcToIntersection(notAnArc, { x: 15, y: 0 }, defaultOptions);
    ...
    it('should reject arcs with non-positive radius', () => {
      ...
      const result = fillArcToIntersection(invalidArc, pointOnCircle(0, 0, 10, Math.PI), defaultOptions);
  ...
  describe('angular calculations', () => {
    ...
    it('should handle near-full circle extensions', () => {
      ...
      const totalAngle = Math.abs(extendedArc.endAngle - extendedArc.startAngle);
  ...
  describe('edge cases', () => {
    it('should handle very small arcs', () => {
      ...
      const result = fillArcToIntersection(tinyArc, intersectionPoint, defaultOptions);
  ...
  describe('extension metadata', () => {
    it('should provide correct extension metadata for end extension', () => {
      ...
      expect(ext.extensionStart).toEqual(pointOnCircle(0, 0, 10, Math.PI / 2));
    ...
    it('should provide correct extension metadata for start extension', () => {
      ...
      expect(ext.extensionStart).toEqual(pointOnCircle(0, 0, 10, Math.PI / 4));
      expect(ext.extensionEnd).toEqual(intersectionPoint);
    });
