...
describe('fillEllipseToIntersection', () => {
    ...
    describe('basic ellipse to arc conversion', () => {
        it('should convert ellipse to elliptical arc when extended', () => {
            ...
            const result = fillEllipseToIntersection(
                ellipse,
                intersectionPoint,
                defaultOptions
            );
            ...
            expect(
                pointsApproxEqual(resultEllipse.center, { x: 0, y: 0 })
            ).toBe(true);
            expect(
                pointsApproxEqual(resultEllipse.majorAxisEndpoint, {
                    x: 4,
                    y: 0,
                })
            ).toBe(true);
        ...
        it('should preserve ellipse properties', () => {
            ...
            const resultEllipse = result.extendedShape!.geometry as Ellipse;
            expect(
                pointsApproxEqual(resultEllipse.center, { x: 5, y: -2 })
            ).toBe(true);
    ...
    describe('extension direction and angular range', () => {
        it('should create elliptical arc with meaningful angular range', () => {
            ...
            if (
                resultEllipse.startParam !== undefined &&
                resultEllipse.endParam !== undefined
            ) {
                let angularRange = Math.abs(
                    resultEllipse.endParam - resultEllipse.startParam
                );
    ...
    describe('existing elliptical arcs', () => {
        it('should extend existing elliptical arc', () => {
            ...
            const intersectionPoint = {
                x: a * Math.cos(newAngle),
                y: b * Math.sin(newAngle),
            };
        ...
        it('should handle very small elliptical arc extension', () => {
            ...
            const intersectionPoint = {
                x: a * Math.cos(extendAngle),
                y: b * Math.sin(extendAngle),
            };
    ...
    describe('numerical precision and edge cases', () => {
        it('should handle very small ellipses', () => {
            ...
            if (result.success) {
                ...
                expect(
                    pointsApproxEqual(
                        resultEllipse.majorAxisEndpoint,
                        { x: 1e-6, y: 0 },
                        1e-12
                    )
                ).toBe(true);
        ...
        it('should respect tolerance for on-ellipse validation', () => {
            ...
            const result1 = fillEllipseToIntersection(
                ellipse,
                slightlyOffPoint,
                {
                    ...defaultOptions,
            ...
            const result2 = fillEllipseToIntersection(
                ellipse,
                slightlyOffPoint,
                {
                    ...defaultOptions,
    ...
    describe('special geometric cases', () => {
        ...
        it('should handle ellipses with large coordinates', () => {
            ...
            const resultEllipse = result.extendedShape!.geometry as Ellipse;
            expect(
                pointsApproxEqual(resultEllipse.center, { x: 1000, y: 2000 })
            ).toBe(true);
        });
        ...
        it('should handle negative coordinate ellipses', () => {
            ...
            const resultEllipse = result.extendedShape!.geometry as Ellipse;
            expect(
                pointsApproxEqual(resultEllipse.center, { x: -5, y: -10 })
            ).toBe(true);
        });
    });
