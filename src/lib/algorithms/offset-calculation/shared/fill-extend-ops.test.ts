...
describe('Fill-Extend Operations Library', () => {
    ...
    const createTestOperationParams = (
        overrides: Partial<OperationParams> = {}
    ): OperationParams => ({
        tolerance: 0.01,
        maxExtension: 100,
    ...
    describe('Ellipse Operations', () => {
        ...
        describe('validateEllipseIntersectionPoint', () => {
            it('should validate point on ellipse', () => {
                ...
                const result = validateEllipseIntersectionPoint(
                    point,
                    ellipse,
                    0.01
                );
            ...
            it('should reject point far from ellipse', () => {
                ...
                expect(result.error).toContain(
                    'Intersection point is not on ellipse'
                );
        ...
        describe('determineEllipseExtension', () => {
            ...
            it('should determine start extension', () => {
                ...
                const result = determineEllipseExtension(
                    ellipse,
                    intersectionAngle,
                    params
                );
        ...
        describe('createEllipticalArcFromEllipse', () => {
            ...
            it('should create arc with start extension', () => {
                ...
                const result = createEllipticalArcFromEllipse(
                    ellipse,
                    intersectionAngle,
                    extensionInfo
                );
    ...
    describe('Circle Operations', () => {
        ...
        describe('validateCircleIntersectionPoint', () => {
            ...
            it('should reject point far from circle', async () => {
                ...
                expect(result.isValid).toBe(false);
                expect(result.error).toContain(
                    'Intersection point is not on circle'
                );
        ...
        describe('determineCircleExtension', () => {
            ...
            it('should determine start extension', () => {
                ...
                const result = determineCircleExtension(
                    circle,
                    intersectionAngle,
                    params
                );
            ...
            it('should limit angular extension by maxExtension', () => {
                ...
                expect(result.success).toBe(true);
                expect(result.angularExtension).toBeLessThanOrEqual(
                    5 / circle.radius
                );
            });
        });
        ...
        describe('createArcFromCircle', () => {
            ...
            it('should create arc with start extension', () => {
                ...
                const result = createArcFromCircle(
                    circle,
                    intersectionAngle,
                    extensionInfo
                );
