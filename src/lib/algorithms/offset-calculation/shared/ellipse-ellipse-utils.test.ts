...
describe('Ellipse-Ellipse Intersection Utilities', () => {
  ...
  describe('calculateEllipseEllipseIntersection', () => {
    it('should calculate intersections between two ellipses', async () => {
      ...
      const results = calculateEllipseEllipseIntersection(ellipse1, ellipse2, false);
      ...
      expect(verb.geom.Intersect.curves).toHaveBeenCalledWith(mockCurve1, mockCurve2, 0.01);
      expect(processVerbIntersectionResults).toHaveBeenCalledWith(mockIntersections, false);
    ...
    it('should handle parameter swapping', async () => {
      ...
      expect(processVerbIntersectionResults).toHaveBeenCalledWith(mockIntersections, true);
    });
    ...
    it('should handle verb-nurbs errors gracefully', async () => {
      ...
      expect(() => calculateEllipseEllipseIntersection(ellipse1, ellipse2)).toThrow();
    });
  });
  ...
  describe('validateEllipseIntersectionParameters', () => {
    it('should validate valid ellipses', () => {
      ...
      const result = validateEllipseIntersectionParameters(ellipse1, ellipse2);
  ...
  describe('processEllipseIntersectionResults', () => {
    it('should process intersection results with filtering', async () => {
      ...
      const results = processEllipseIntersectionResults(rawResults, false, true);

      expect(processVerbIntersectionResults).toHaveBeenCalledWith(rawResults, false);
    ...
    it('should skip filtering when filterDuplicates is false', async () => {
      ...
      const results = processEllipseIntersectionResults(rawResults, false, false);
    ...
    it('should handle parameter swapping', async () => {
      ...
      expect(processVerbIntersectionResults).toHaveBeenCalledWith(rawResults, true);
    });
  });
  ...
  describe('calculateIntersectionScore', () => {
    it('should calculate minimum distance to endpoints', () => {
      ...
      const score = calculateIntersectionScore(intersection, e1Start, e1End, e2Start, e2End);
  ...
  describe('findEllipseEllipseIntersectionsVerb', () => {
    it('should find intersections between ellipse shapes', async () => {
      ...
      const results = findEllipseEllipseIntersectionsVerb(shape1, shape2, false);
    ...
    it('should handle parameter swapping', async () => {
      ...
      const results = findEllipseEllipseIntersectionsVerb(shape1, shape2, true);

      expect(processVerbIntersectionResults).toHaveBeenCalledWith([], true);
    ...
    it('should handle verb-nurbs intersection failures', async () => {
      ...
      expect(() => findEllipseEllipseIntersectionsVerb(shape1, shape2)).toThrow();
    });
  });
  ...
  describe('Duplicate Filtering', () => {
    ...
    it('should keep intersections that are far apart', async () => {
      ...
      const mockProcessedResults: IntersectionResult[] = rawResults.map(r => ({
        point: { x: r.pt[0], y: r.pt[1] },
        param1: r.u0,
        param2: r.u1,
        distance: 0.01,
  ...
  describe('Edge Cases', () => {
    it('should handle identical ellipses', async () => {
      ...
      const results = calculateEllipseEllipseIntersection(ellipse1, ellipse2);
    ...
    it('should handle ellipses that do not intersect', async () => {
      const ellipse1 = createTestEllipse();
      const ellipse2 = createTestEllipse({ center: { x: 1000, y: 1000 } }); // Far away
