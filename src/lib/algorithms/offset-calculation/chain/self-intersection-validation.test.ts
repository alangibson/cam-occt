...
describe('Chain Self-Intersection Validation', () => {
     ...
     */
    function createChainFromPolylineShape(
        polylineShape: Shape,
    ...
    describe('Self-Intersecting Polyline Offsets', () => {
        it('should detect self-intersections in figure-8 polyline offsets', () => {
            ...
            const chain = createChainFromPolylineShape(
                polyline,
                'figure8-chain'
            );
            ...
            if (outsetResult.outerChain) {
                ...
                if (outsetResult.outerChain.intersectionPoints) {
                    expect(
                        outsetResult.outerChain.intersectionPoints.length
                    ).toBeGreaterThan(0);
                }
            }
        ...
        it('should not report self-intersections in simple non-intersecting polylines', () => {
            ...
            if (
                ...
                const actualSelfIntersections =
                    offsetResult.outerChain.intersectionPoints.filter(
    ...
    describe('Self-Intersection Reporting', () => {
            ...
            if (
                ...
                offsetResult.outerChain.intersectionPoints.forEach(
                    (intersection) => {
                        ...
                        expect(intersection.confidence).toBeGreaterThanOrEqual(
                            0
                        );
        ...
        it('should handle complex polylines with many potential self-intersections', () => {
            ...
            const secondOffsetResult: ChainOffsetResult = offsetChain(
                chain,
                0.5,
                params
            );
    ...
    describe('Integration with Chain Offset Parameters', () => {
        it('should respect polylineIntersections parameter setting', () => {
            ...
            const resultDisabled: ChainOffsetResult = offsetChain(
                chain,
                2,
                paramsDisabled
            );
            ...
            const resultEnabled: ChainOffsetResult = offsetChain(
                chain,
                2,
                paramsEnabled
            );
            ...
            if (resultEnabled.outerChain) {
                expect(
                    resultEnabled.outerChain.intersectionPoints
                ).toBeDefined();
            }
        });
