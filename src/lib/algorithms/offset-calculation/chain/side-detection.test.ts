...
describe('side-detection', () => {
  ...
  describe('detectChainSide', () => {
    it('should detect inner offset for closed square chain', () => {
      ...
      const result = detectChainSide(innerOffsetLine, -2, chain, 0.1, true);
    ...
    it('should detect outer offset for closed square chain', () => {
      ...
      const result = detectChainSide(outerOffsetLine, 2, chain, 0.1, true);
    ...
    it('should detect left offset for open L-shaped chain', () => {
      ...
      const result = detectChainSide(leftOffsetLine, 2, chain, 0.1, false);
    ...
    it('should detect right offset for open L-shaped chain', () => {
      ...
      const result = detectChainSide(rightOffsetLine, -2, chain, 0.1, false);
    ...
    it('should handle arc offsets in closed chain', () => {
      ...
      const result = detectChainSide(innerOffsetArc, -2, chain, 0.1, true);
  ...
  describe('isPointInsideChain', () => {
    ...
    it('should throw error for open chains', () => {
      ...
      expect(() => isPointInsideChain({ x: 5, y: 5 }, chain)).toThrow('Cannot check point containment for open chain');
    });
  });
  ...
  describe('determineChainOrientation', () => {
    ...
    it('should throw error for closed chains', () => {
      ...
      expect(() => determineChainOrientation(chain)).toThrow('Chain orientation is only defined for open chains');
    });
  });
