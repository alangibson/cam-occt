...
describe('Polyline-Arc Extension Intersections', () => {
  test('should find intersection with extended polyline', () => {
    ...
    const noExtensions = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, false);
    expect(noExtensions).toHaveLength(0);
    
    // With extensions - should find intersection where extended polyline meets arc
    const withExtensions = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, true, 1000);
  ...
  test('should find intersection with extended arc', () => {
    ...
    const withExtensions = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, true, 20);
    expect(withExtensions.length).toBeGreaterThan(0);
  ...
  test('should return original intersections when they exist', () => {
    ...
    const intersections = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, true, 1000);
  ...
  test('should handle closed polyline correctly', () => {
    ...
    const intersections = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, false);
  ...
  test('should handle parameter swapping correctly', () => {
    ...
    const normalOrder = findPolylineArcIntersections(polyline.geometry as Polyline, arc, false, false);
    expect(normalOrder.length).toBeGreaterThan(0);
    
    // Test swapped parameter order
    const swappedOrder = findPolylineArcIntersections(polyline.geometry as Polyline, arc, true, false);
