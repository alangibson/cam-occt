...
export function findEllipseArcIntersectionsVerb(
  ...
  const intersections: CurveCurveIntersection[] = verb.geom.Intersect.curves(ellipseCurve, arcCurve, INTERSECTION_TOLERANCE);
 ...
 */
export function findEllipseArcIntersections(ellipseShape: Shape, arcShape: Shape, swapParams: boolean): IntersectionResult[] {
