...
import { findLineArcIntersections, findLineArcIntersectionsSegmentAware, type SegmentPosition } from '../line-arc/index';
...
export function findLineCircleIntersections(
  ...
  return findLineArcIntersections(line, arc, swapParams, allowExtensions, extensionLength);
}
...
export function findLineCircleIntersectionsSegmentAware(
  ...
  return findLineArcIntersectionsSegmentAware(line, arc, segmentPosition, swapParams);
}