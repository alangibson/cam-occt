...
describe('Line-Line Extension Intersections', () => {
    ...
    it('finds gap intersection when extending both lines', () => {
        ...
        const intersections = findLineLineIntersections(
            line1,
            line2,
            false,
            true,
    ...
    it('handles collinear overlapping lines with extensions', () => {
        ...
        expect(
            intersections.some((i) => i.point.x === 3 && i.point.y === 0)
        ).toBe(true);
        expect(
            intersections.some((i) => i.point.x === 5 && i.point.y === 0)
        ).toBe(true);
    });
    ...
    it('respects extension length parameter', () => {
        ...
        const shortExtension = findLineLineIntersections(
            line1,
            line2,
            false,
            true,
        ...
        const longExtension = findLineLineIntersections(
            line1,
            line2,
            false,
            true,
