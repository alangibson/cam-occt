...
import type { Polyline, Chain, Shape, Line } from '../../types/geometry';
  ...
  describe('joinColinearLinesInPolyline', () => {
    ...
    it('should handle lines in reverse direction', () => {
      ...
      expect(
        ...
        (joinedGeometry.start.x === 20 && joinedGeometry.end.x === 0)
      ).toBe(true);
    });
  });
      ...
      const chain1: Chain = {
        ...
        shapes: [
          ...
          },
          {
            id: generateId(),
            type: 'line',
            geometry: { start: { x: 10, y: 0 }, end: { x: 20, y: 0 } } as Line
          }
        ]
      };
        ...
        shapes: [
          {
            id: generateId(),
            type: 'line',
            geometry: { start: { x: 0, y: 10 }, end: { x: 5, y: 10 } } as Line
          },
          {
            id: generateId(),
            type: 'line',
            geometry: { start: { x: 5, y: 10 }, end: { x: 10, y: 10 } } as Line
          }
        ]
      };
