...
import { countRayLineCrossings, findRayLineIntersections, countHorizontalRayLineCrossings } from './ray-line';
...
describe('Ray-Line Intersection', () => {
  ...
  describe('findRayLineIntersections', () => {
    it('should find intersection point correctly', () => {
      ...
      const intersections = findRayLineIntersections(ray, line, defaultConfig);
  ...
  describe('countHorizontalRayLineCrossings', () => {
    it('should count horizontal ray crossings efficiently', () => {
      ...
      const crossings = countHorizontalRayLineCrossings(rayOrigin, line, defaultConfig);
      expect(crossings).toBe(1);
    });
    ...
    it('should apply lower-inclusive boundary rule', () => {
      ...
      const crossings1 = countHorizontalRayLineCrossings(rayOrigin, line1, defaultConfig);
      const crossings2 = countHorizontalRayLineCrossings(rayOrigin, line2, defaultConfig);
