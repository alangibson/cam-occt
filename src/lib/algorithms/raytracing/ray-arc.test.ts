...
import { countRayArcCrossings, findRayArcIntersections, countHorizontalRayArcCrossings } from './ray-arc';
...
describe('Ray-Arc Intersection', () => {
  ...
  describe('findRayArcIntersections', () => {
    it('should find intersection points for 90° arc', () => {
      ...
      const intersections = findRayArcIntersections(ray, arc, defaultConfig);
  ...
  describe('countHorizontalRayArcCrossings', () => {
    it('should handle horizontal ray efficiently', () => {
      ...
      const crossings = countHorizontalRayArcCrossings(rayOrigin, arc, defaultConfig);
