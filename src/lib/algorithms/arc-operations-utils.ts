 ...
 */
export function createArcExtensionOptions(options: FillOptions): ArcExtensionOptions {
  return {
    maxExtension: options.maxExtension,
    tolerance: options.tolerance,
    direction: options.extendDirection === 'start' ? 'start' : 
 ...
 */
export function validateArcExtensionDirection(direction: ExtensionDirection): boolean {
  const validDirections: ExtensionDirection[] = ['start', 'end', 'both', 'auto'];
