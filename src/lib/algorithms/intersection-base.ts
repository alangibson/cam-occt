 ...
 */
export function processIntersectionResults(results: CurveCurveIntersection[], swapParams: boolean): IntersectionResult[] {
 ...
 */
export const handleClosedPolylineIntersections: typeof handleClosedPolylineIntersection = handleClosedPolylineIntersection;
