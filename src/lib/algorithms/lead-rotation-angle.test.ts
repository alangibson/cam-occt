...
describe('Lead Rotation Angle', () => {
    ...
    describe('Lead-in angle behavior', () => {
        it('should point to the right when angle is 0 degrees (unit circle convention)', () => {
            ...
            expect(Math.abs(leadStartPoint.y - connectionPoint.y)).toBeLessThan(
                0.001
            ); // Same Y coordinate
        });
        ...
        it('should point up when angle is 90 degrees', () => {
            ...
            expect(Math.abs(leadStartPoint.x - connectionPoint.x)).toBeLessThan(
                0.001
            ); // Same X coordinate
        });
    ...
    describe('Lead-out angle behavior', () => {
        it('should point to the right when angle is 0 degrees (unit circle convention)', () => {
            ...
            const leadEndPoint =
                result.leadOut!.points[result.leadOut!.points.length - 1];
            ...
            expect(Math.abs(leadEndPoint.y - connectionPoint.y)).toBeLessThan(
                0.001
            ); // Same Y coordinate
        });
        ...
        it('should point up when angle is 90 degrees', () => {
            ...
            expect(Math.abs(leadEndPoint.x - connectionPoint.x)).toBeLessThan(
                0.001
            ); // Same X coordinate
        });
    });
