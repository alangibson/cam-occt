...
import type { Point2D as _Point2D } from '$lib/geometry/point/interfaces';
...
describe('CoordinateTransformer', () => {
    ...
    describe('Fixed Origin Position', () => {
        ...
        it('should maintain origin position when canvas resizes', () => {
            ...
            const transformer2 = new CoordinateTransformer(resizedCanvas, 1, {
                x: 0,
                y: 0,
            });
    ...
    describe('Screen to World Transformation', () => {
        ...
        it('should apply scale correctly', () => {
            const transformer2x = new CoordinateTransformer(canvas, 2, {
                x: 0,
                y: 0,
            });
        ...
        it('should apply offset correctly', () => {
            const transformerOffset = new CoordinateTransformer(canvas, 1, {
                x: 50,
                y: -50,
            });
        ...
        it('should handle physical scale factor', () => {
            const transformerPhys = new CoordinateTransformer(
                canvas,
                1,
                { x: 0, y: 0 },
                2
    ...
    describe('World to Screen Transformation', () => {
        ...
        it('should apply combined scale correctly', () => {
            const transformer3x = new CoordinateTransformer(
                canvas,
                3,
                { x: 0, y: 0 },
                2
    ...
    describe('Edge Cases', () => {
        it('should handle zero scale gracefully', () => {
            ...
            const transformerZero = new CoordinateTransformer(canvas, 0.01, {
                x: 0,
                y: 0,
            });
    ...
    describe('Zoom Behavior', () => {
        it('should zoom toward a specific point correctly', () => {
            ...
            const finalScreenPoint =
                transformerWithOffset.worldToScreen(worldZoomPoint);
    ...
    describe('calculateZoomOffset', () => {
        it('should calculate offset to keep zoom point fixed', () => {
            ...
            const newOffset = transformer.calculateZoomOffset(
                zoomPoint,
                oldScale,
                newScale
            );
            ...
            const newScreenPoint =
                newTransformer.worldToScreen(originalWorldPoint);
        ...
        it('should handle zoom out correctly', () => {
            ...
            const newOffset = transformer2x.calculateZoomOffset(
                zoomPoint,
                oldScale,
                newScale
            );
        ...
        it('should handle physical scale in zoom calculations', () => {
            ...
            const newOffset = transformerWithPhys.calculateZoomOffset(
                zoomPoint,
                oldScale,
                newScale
            );
            ...
            const originalWorldPoint =
                transformerWithPhys.screenToWorld(zoomPoint);
            const newScreenPoint =
                newTransformer.worldToScreen(originalWorldPoint);
    ...
    describe('getTotalScale', () => {
        it('should return scale times physical scale', () => {
            ...
            const transformerScaled = new CoordinateTransformer(
                canvas,
                scale,
                { x: 0, y: 0 },
                physicalScale
            ...
            expect(transformerScaled.getTotalScale()).toBe(
                scale * physicalScale
            );
        });
    ...
    describe('worldToScreenDistance', () => {
        it('should convert world distance to screen pixels', () => {
            ...
            const screenDistance =
                transformer.worldToScreenDistance(worldDistance);

            expect(screenDistance).toBe(
                worldDistance * transformer.getTotalScale()
            );
        });
        ...
        it('should handle physical scale factor', () => {
            ...
            const screenDistance =
                transformerWithPhys.worldToScreenDistance(worldDistance);
    ...
    describe('screenToWorldDistance', () => {
        it('should convert screen pixels to world distance', () => {
            ...
            const worldDistance =
                transformer.screenToWorldDistance(screenDistance);

            expect(worldDistance).toBe(
                screenDistance / transformer.getTotalScale()
            );
        });

        it('should be inverse of worldToScreenDistance', () => {
            const originalWorldDistance = 75;
            const screenDistance = transformer.worldToScreenDistance(
                originalWorldDistance
            );
            const worldDistanceBack =
                transformer.screenToWorldDistance(screenDistance);
        ...
        it('should handle combined scale factors', () => {
            ...
            const worldDistance =
                transformerScaled.screenToWorldDistance(screenDistance);

            expect(worldDistance).toBe(
                screenDistance / (scale * physicalScale)
            );
        });
    });
    ...
    describe('Extreme Values and Edge Cases', () => {
        it('should handle extremely small scale values', () => {
            ...
            const transformerSmall = new CoordinateTransformer(
                canvas,
                verySmallScale,
                {
                    x: 0,
        ...
        it('should handle extremely large scale values', () => {
            ...
            const transformerLarge = new CoordinateTransformer(
                canvas,
                veryLargeScale,
                {
                    x: 0,
        ...
        it('should handle zero world coordinates with various scales', () => {
            ...
            scales.forEach((scale) => {
                const t = new CoordinateTransformer(canvas, scale, {
                    x: 0,
                    y: 0,
                });
