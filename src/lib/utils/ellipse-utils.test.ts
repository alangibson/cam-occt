...
describe('ellipse-utils', () => {
  ...
  describe('distanceFromEllipsePerimeter', () => {
    it('should return 0 for point on ellipse perimeter', () => {
      ...
      const distance = distanceFromEllipsePerimeter(pointOnPerimeter, unitCircle);
    ...
    it('should return positive distance for point outside ellipse', () => {
      ...
      const distance = distanceFromEllipsePerimeter(pointOutside, unitCircle);
    ...
    it('should return positive distance for point inside ellipse', () => {
      ...
      const distance = distanceFromEllipsePerimeter(pointInside, unitCircle);
    ...
    it('should work for horizontal ellipse', () => {
      ...
      const distance = distanceFromEllipsePerimeter(pointOnPerimeter, horizontalEllipse);
