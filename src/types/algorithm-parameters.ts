...
// Re-export existing part detection parameters
import type { PartDetectionParameters } from './part-detection';
import { DEFAULT_PART_DETECTION_PARAMETERS } from './part-detection';
export type { PartDetectionParameters } from './part-detection';
export { DEFAULT_PART_DETECTION_PARAMETERS } from './part-detection';
