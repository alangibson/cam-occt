...
describe('Operations Component - Function Coverage', () => {
  ...
  describe('operation management functions', () => {
    ...
    it('should delete operation correctly', async () => {
      ...
      const deleteButton = container.querySelector('[title="Delete operation"]');
      if (deleteButton) {
  ...
  describe('tool selection functions', () => {
    ...
    it('should select tool', async () => {
      ...
      const toolOption = container.querySelector('.tool-option:not([data-tool-id="null"])');
      if (toolOption) {
  ...
  describe('apply-to menu functions', () => {
    ...
    it('should toggle apply-to menu', async () => {
      ...
      if (applyToButton) {
        ...
        const applyToMenu = container.querySelector('.apply-to-dropdown');
  ...
  describe('hover functions', () => {
    it('should handle part hover', async () => {
      ...
      const partLabel = container.querySelector('[data-part-id="part-1"]');
      if (partLabel) {
    ...
    it('should handle chain hover', async () => {
      ...
      const chainLabel = container.querySelector('[data-chain-id="chain-1"]');
      if (chainLabel) {
  ...
  describe('operation field updates', () => {
    ...
    it('should update operation name', async () => {
      ...
      const nameInput = container.querySelector('.operation-name-input') as HTMLInputElement;
    ...
    it('should toggle operation enabled state', async () => {
      ...
      const enabledCheckbox = container.querySelector('.enabled-checkbox') as HTMLInputElement;
