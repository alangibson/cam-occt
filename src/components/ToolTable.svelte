<script lang="ts">
  ...
  function addNewTool() {
    const newToolNumber = tools.length > 0 
...
<div class="tool-table-container">
  <div class="toolbar">
    <h2>Tool Table</h2>
    <button onclick={addNewTool} class="btn btn-primary">
      Add Tool
    </button>
  </div>
          ...
          >
            ...
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'toolNumber', parseInt(e.currentTarget.value))}
                class="input-xs"
              />
            </td>
            <td>
              <input
                type="text"
                value={tool.toolName}
                onchange={(e) => updateToolField(tool.id, 'toolName', e.currentTarget.value)}
                class="input-sm"
              />
            </td>
            <td>
            ...
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'pierceHeight', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'pierceDelay', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'arcVoltage', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'kerfWidth', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.01"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'thcEnable', e.currentTarget.checked)}
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'gasPressure', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'pauseAtEnd', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'puddleJumpHeight', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'puddleJumpDelay', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td>
              <input
                ...
                onchange={(e) => updateToolField(tool.id, 'plungeRate', parseFloat(e.currentTarget.value))}
                class="input-xs"
                step="0.1"
              />
            </td>
            <td class="actions-cell">
              <button onclick={() => duplicateTool(tool)} class="btn btn-primary btn-small" title="Duplicate tool">
                ⎘
              </button>
              <button onclick={() => deleteTool(tool.id)} class="btn btn-danger btn-small" title="Delete tool">
                ✕
              </button>
            </td>
          </tr>
